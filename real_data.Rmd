...
color_map <- c(
  "session1.cs" = "#009E73", "session2.cs" = "#009E73",
  "session1.cp" = "#E69F00", "session2.cp" = "#E69F00",
  "session1.mcp" = "#D55E00", "session2.mcp" = "#D55E00",
  "session1.pelt" = "#CC79A7", "session2.pelt" = "#CC79A7",
  "session1.ecp" = "#0072B2", "session2.ecp" = "#0072B2"
)

p.box <- ggplot(data_long, aes(x = group, y = onset, fill = group)) +
  geom_boxplot(outlier.shape = NA, alpha = 0.6) +
  geom_jitter(width = 0.15, size = 1, alpha = 0.4, color = "black") +
  scale_fill_manual(values = color_map) +
  labs(x = "Session", y = "Onset (ms)", title = "Onset Times by Method and Session") +
  theme_minimal() +
  theme(plot.title = element_text(size = 20)) +
  theme_gar +
  coord_flip()
