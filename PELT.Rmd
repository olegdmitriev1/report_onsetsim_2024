...
# Separate these chunks before submission, add title in betwee ## Signal + noise creation
...
```
This is the same as above but with 300 simulations instead of 10.
```{r}
