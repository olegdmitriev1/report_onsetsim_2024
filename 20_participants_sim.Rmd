...
# mcp model
model <- list(
  y ~ 1 + sigma(1), # first segment of the model, y ~ 1 implies that variable y includes an intercept, sigma(1) is the specification for standard deviation of residuals
    ~ 0 + x + sigma(1) # second segment of the model
)
...
# Initialising empty matrixes to store results for each method
...
Needed to merge the separate files storing 100 iterations 
