...
save_results <- function(iteration, simres.cs, simres.fdr, simres.cp, simres.pelt, simres.mcp, simres.ecp) {
  filename <- sprintf("./group20_sim_incr_save_data/main_sim_n50_eeg_group20_iter_%d.RData", iteration)
...
setwd("./group20_sim_incr_save_data/")
...
save(simres.cs, simres.fdr, simres.cp, simres.pelt, simres.mcp, simres.ecp,
     file = "./main_sim_n50_eeg_group20.RData")
...
```{r, warning=FALSE}
load("./group20_sim_incr_save_data/main_sim_n50_eeg_group20.RData")
